...
const templates = {
  project: () => ({ id: createId('project'), year: new Date().getFullYear().toString(), title: 'New project', category: 'Software project', description: 'Describe the problem and why this project matters.', impact: 'Describe what you designed and built.', skills: [], image: 'portfolio', imageAlt: 'Project preview', link: '', linkLabel: 'View project' }),
  experience: () => ({ id: createId('experience'), type: 'work', role: 'New role', company: 'Organization', location: 'Location', period: 'Dates', description: 'Describe your responsibilities and impact.', skills: [], url: '' }),
  education: () => ({ id: createId('education'), school: 'School', degree: 'Degree or program', period: 'Dates', locations: 'Location', gpa: '', description: 'Describe the program and areas of focus.', coursework: [] }),
